...
$envelope = '<li></li>';
$loginLink = '<li><a id="login" href="in.php">Log In</a></li><li> <a id="signup" href="up.php">Sign Up</a></li>';
if(isset($_GET["fp"])){
	$loginLink .= '<li> <a class="current" id="forgot" href="forgot.php">Forgot Password</a></li>';
}
